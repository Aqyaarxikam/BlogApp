...
class _PostScreenState extends State<PostScreen> {
      ...
      home: ModalProgressHUD(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            backgroundColor:  Color.fromARGB(255, 42, 69, 164),
            title: Text(
              'Upload Blogs ',
  ...
  decoration: InputDecoration(
    ...
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(13), // Adjust the border radius value here
    ),
    hintStyle: TextStyle(
      color: Colors.grey,
...
SizedBox(
  ...
  decoration: InputDecoration(
    ...
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(15), // Adjust the border radius value here
    ),
    hintStyle: TextStyle(
      color: Colors.grey,
      fontWeight: FontWeight.normal,
    ...
    contentPadding: EdgeInsets.symmetric(vertical: 50, horizontal: 12), // Adjust the padding values here
    isDense: true, // Reduce the height of the input area to accommodate the padding
  ),
),
                      ],
                    ),
